        ...
        >
          <v-dialog transition="dialog-top-transition" max-width="600">
            ...
            <template v-slot:default="">
              <v-card >
                <v-toolbar v-if="montante!=null && montante>0 && user.accept==true && (parseFloat(saldo[select.state]) - parseFloat(montante)) >= 0" color="#063606">
                  <p style="color: white">
                ...
                <v-card-text style="padding-top: 20px; padding-left: 16px">
                  <div v-if="montante!=null && montante>0 && user.accept==true && (parseFloat(saldo[select.state]) - parseFloat(montante)) >= 0" class="fontUser font-size: 30px; ">
                  ...
                  <div v-else class="fontUser font-size: 30px;">
                    Por favor verifique o montante a levantar.
                  </div>
                </v-card-text>
                <v-card-actions class="justify-end">
                  <v-btn text @click="() => levantarSaldo()">Ir para a página inicial</v-btn>
                </v-card-actions>
              </v-card>
            </template>
          </v-dialog>
